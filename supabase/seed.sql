...
insert into public.product (sku, name, category, unit_price, min_stock, stock, currency_code, is_active)
values 
  ('AA-100000', 'Wireless Mouse', 'Electronics', 19.99, 10, 11, 'MMK', true),
  ('AA-100001', 'Mechanical Keyboard', 'Electronics', 49.99, 5, 4, 'MMK', true),
  ('AA-100002', 'Reusable Water Bottle', 'Home & Kitchen', 12.50, 20, 20, 'MMK', true),
  ('AA-100003', 'Notebook 200 Pages', 'Stationery', 3.25, 50, 55, 'MMK', true),
  ('AA-100004', 'LED Desk Lamp', 'Home & Office', 24.95, 8, 10, 'MMK', true);
