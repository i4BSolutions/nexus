alter table "public"."pruchase_invoice_audit_log" add constraint "pruchase_invoice_audit_log_changed_by_fkey" FOREIGN KEY (changed_by) REFERENCES profiles(id) not valid;
